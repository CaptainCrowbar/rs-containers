...
// This is just to save a bit of horizontal space
#define LENGTH_ERROR(expr) TEST_THROW(expr, std::length_error, "length exceeds bound")
...
void test_rs_containers_bounded_array_tracking() {
    ...
    LENGTH_ERROR(a.resize(20));                                   TEST_EQUAL(a.size(), 10u);  TEST_EQUAL(CI::count(), 10);
    ...
    LENGTH_ERROR(a.push_back(42));                                TEST_EQUAL(a.size(), 10u);  TEST_EQUAL(CI::count(), 10);
    ...
    LENGTH_ERROR(a.insert(a.begin() + 3, 42));                    TEST_EQUAL(a.size(), 10u);  TEST_EQUAL(CI::count(), 10);
    ...
    LENGTH_ERROR(a.insert(a.begin(), v5.begin(), v5.end()));      TEST_EQUAL(a.size(), 10u);  TEST_EQUAL(CI::count(), 10);
    ...
    LENGTH_ERROR(a.insert(a.begin() + 2, v5.begin(), v5.end()));  TEST_EQUAL(a.size(), 10u);  TEST_EQUAL(CI::count(), 10);
    ...
    LENGTH_ERROR(a.insert(a.end(), v5.begin(), v5.end()));        TEST_EQUAL(a.size(), 10u);  TEST_EQUAL(CI::count(), 10);
    ...
    LENGTH_ERROR(a.append(std::move(v5)));                        TEST_EQUAL(a.size(), 10u);  TEST_EQUAL(CI::count(), 10);
