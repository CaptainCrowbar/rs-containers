...
void test_rs_containers_ring_buffer_static_queue_eject() {
...

    {
        ...
        RingBuffer<CI, RingPolicy::queue | RingPolicy::evict, 5> buf;
        std::string str;
...
void test_rs_containers_ring_buffer_static_queue_reject() {
...

    {
        ...
        RingBuffer<CI, RingPolicy::queue | RingPolicy::reject, 5> buf;
        std::string str;
...
void test_rs_containers_ring_buffer_static_stack_eject() {
...

    {
        ...
        RingBuffer<CI, RingPolicy::stack | RingPolicy::evict, 5> buf;
        std::string str;
...
void test_rs_containers_ring_buffer_static_stack_reject() {
...

    {
        ...
        RingBuffer<CI, RingPolicy::stack | RingPolicy::reject, 5> buf;
        std::string str;
